...
import 'package:uas_mp/cubit/resep_makanan_cubit.dart';
import 'package:uas_mp/screen/detail_resep_makanan_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Column(
          children: [
            Center(child: Text('Hanief Aditiawan-191011450345')),
            Text('Resep Makanan'),
          ],
        ),
      ),
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return DetailResepMakananScreen(
                            linkResepMakanan: resepMakananCubit
                                .resepMakananModel.results?[index].key!,
                            imageResepMakanan: resepMakananCubit
                                .resepMakananModel.results?[index].title!,
                            descriptionResepMakanan: resepMakananCubit
